...
<body>
    <nav class="navbar navbar-expand-lg">
        <ul class="navbar-nav">
            ...
            <li class="nav-item"><a class="nav-link" href="../pages/Profile-Farez.php?email=<?php echo $_SESSION['email']?>">Profile</a></li>
        </ul>
    </nav>
    <div class="row mx-auto w-75 p-3 mt-2">
        <div class="col-6 text-justify">
            ...
            <?php
                ...
                echo '<a class="btn btn-primary" href="../pages/Add-Farez.php">MyCar</a>';
            ?>
        </div>
        <div class="col">
    ...
    <div class="row">
        <div class="col-6">
            <img src="/MODUL4 FAREZ/logo-ead.png" style="width:100px;height:30px;float:left"></img>
