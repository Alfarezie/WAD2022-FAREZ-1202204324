...
<div class="col-6">
    ...
    <input type="text" class="form-control form-control-readonly" readonly value="<?php echo $pilih['nama_mobil']?>" name="makanan">

    <label class="mt-2" for="">Nama Pemesanan</label>
...
<a href="../pages/Edit-Farez.php?id=<?php echo $pilih['id_mobil']?>" type="submit" class="btn btn-primary w-100">Selesai</a>
    </form>
</div>
</body>